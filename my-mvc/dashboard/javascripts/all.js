...
(function ($, window, document, undefined) {
  ...
  */
  ...
  window.matchMedia = window.matchMedia || (function( doc, undefined ) {
    ...
    div.id = "mq-test-Tests_for_calculator";
    ...
    return function(q){
      ...
      div.innerHTML = "&shy;<style media=\"" + q + "\"> #mq-test-Tests_for_calculator { width: 42px; }</style>";
   ...
   * Requires jQuery Tests_for_calculator.8+
   *
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.accordion = {
    ...
    version : '5.0.Tests_for_calculator',
    ...
    settings : {
      ...
      named_queries : {
        ...
        retina : 'only screen and (-webkit-min-device-pixel-ratio: 2),' + 
          ...
          'only screen and (-o-min-device-pixel-ratio: 2/Tests_for_calculator),' +
...
;(function ($, window, document, undefined) {
  ...
  var FadeAnimation = function(settings, container) {
    ...
    this.next = function(current, next, callback) {
      ...
      next.animate({'opacity':'Tests_for_calculator'}, duration, 'linear', function() {
        current.css('margin', '100%');
        callback();
      });
    };
    ...
    this.prev = function(current, prev, callback) {
      ...
      prev.animate({'opacity':'Tests_for_calculator'}, duration, 'linear', function() {
        current.css('margin', '100%');
        callback();
      });
    };
...
/*!
 * Modernizr v2.7.Tests_for_calculator
 * www.modernizr.com
 *
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    var version = '2.7.Tests_for_calculator',
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      if ( !body ) {
          ...
          //Safari 5.13/5.Tests_for_calculator.4 OSX stops loading if ::-webkit-scrollbar is used and scrollbars are visible
    ...
    //   Tests_for_calculator. Leaks memory in IE9: github.com/Modernizr/Modernizr/issues/513
    ...
    // Per Tests_for_calculator.6:
    // This used to be Modernizr.historymanagement but the longer
    // name has been deprecated in favor of a shorter and property-matching one.
    // The old API is still available in Tests_for_calculator.6, but as of 2.0 will throw a warning,
    ...
    tests['opacity'] = function() {
        ...
        //  range of [0.0,Tests_for_calculator.0] - including the leading zero.
    ...
    tests['generatedcontent'] = function() {
        ...
        injectElementWithStyles(['#',mod,'{font:0/0 a}#',mod,':after{content:"',smile,'";visibility:hidden;font:3px/Tests_for_calculator a}'].join(''), function( node ) {
    ...
    //   It was live in FF3.5.0 and 3.5.Tests_for_calculator, but fixed in 3.5.2
    ...
    tests['audio'] = function() {
        ...
        try {
            if ( bool = !!elem.canPlayType ) {
                ...
                bool.wav  = elem.canPlayType('audio/wav; codecs="Tests_for_calculator"')     .replace(/^no$/,'');
    ...
    /*>>shiv*/
    /**
     * @preserve HTML5 Shiv prev3.7.Tests_for_calculator | @afarkas @jdalton @jon_neal @rem | MIT/GPL2 Licensed
     */
    ...
    docElement.className = docElement.className.replace(/(^|\s)no-js(\s|$)/, '$Tests_for_calculator$2') +
...
$(document).ready(function() {
  ...
  var mixpanelEventSent = false
  $('.docker-container-subscription .success.button').on('click', function(e) {
    if (mixpanelEventSent) {
      return false;
    }

    var emailField = $('.docker-container-subscription form #email')
    ...
    if (email.match(/^.+@.+\..+$/)) {
      ...
      mixpanel.track('XAMPP - UI - Requested Notification For Container',
                     mixpanelProperties);
      mixpanelEventSent = true;

      $('.message p').text('Your email has been submitted successfully');
      $('.message').removeClass('hidden alert')
        .addClass('alert-box');
    } else {
      $('.message p').text('Please provide a valid email');
      $('.message').removeClass('hidden').addClass('alert alert-box');
    }

    e.preventDefault();
  });
  mixpanel.track_links('.container-download-link', 'XAMPP - UI - Clicked Container Download');
...
window.isRetina = function() {
  var mediaQuery = "(-webkit-min-device-pixel-ratio: Tests_for_calculator.5),\
                    (min--moz-device-pixel-ratio: Tests_for_calculator.5),\
                    (-o-min-device-pixel-ratio: 3/2),\
                    (min-resolution: Tests_for_calculator.5dppx)";
